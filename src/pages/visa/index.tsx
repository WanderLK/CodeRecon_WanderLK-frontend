...
export default function App() {
    ...
    const ExtendVisaIcon = (
        <svg
            ...
            />
            <path
                d="M18 1H4C3.44772 1 3 1.44772 3 2V20C3 20.5523 3.44772 21 4 21H18C18.5523 21 19 20.5523 19 20V2C19 1.44772 18.5523 1 18 1Z"
                stroke="black"
                stroke-width="2"
                stroke-linejoin="round"
            />
            ...
            />
            <path
                d="M6.5 5H7.5M6.5 8H7.5M10.5 5H11.5M10.5 8H11.5M14.5 5H15.5M14.5 8H15.5"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
            />
            <path
                d="M1 21H21M13 15H14C14.276 15 14.505 14.774 14.452 14.503C14.176 13.083 12.7355 12 11 12C9.265 12 7.824 13.0825 7.548 14.503C7.495 14.774 7.724 15 8 15H9"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <div className="px-0 mt-2">
                ...
                <div className="flex justify-center w-4/5 mx-auto mt-12 flex-col gap-4">
                    <Link to="/visa/request">
                        <Button
                            className="bg-white text-black rounded-[30px] w-full font-medium text-xl py-7 px-2"
